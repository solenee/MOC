...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#gen","RX -> #extension #adresse #gen ;"});
}
  }
...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#verifType","RX -> OPADD T #verifType #hcode #hadresse RX1 #extension #adresse #gen ;"});
}
  }
...
// instructions
this.att_vide=true;
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#extension","RX -> #extension #adresse #gen ;"});
}
  }
...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#gen","RX -> OPADD T #verifType #hcode #hadresse RX1 #extension #adresse #gen ;"});
}
  }
...
// instructions
this.att_vide=false;
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#extension","RX -> OPADD T #verifType #hcode #hadresse RX1 #extension #adresse #gen ;"});
}
  }
...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#adresse","RX -> OPADD T #verifType #hcode #hadresse RX1 #extension #adresse #gen ;"});
}
  }
...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#adresse","RX -> #extension #adresse #gen ;"});
}
  }
...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#hadresse","RX -> OPADD T #verifType #hcode #hadresse RX1 #extension #adresse #gen ;"});
}
  }
...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#hcode","RX -> OPADD T #verifType #hcode #hadresse RX1 #extension #adresse #gen ;"});
}
  }
...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#auto_inh","RX -> OPADD T #verifType #hcode #hadresse RX1 #extension #adresse #gen ;"});
}
  }
  public void analyser () throws Exception {
    ...
    switch ( scanner.fenetre[0].code ) {
      ...
      case LEX_MOC.token_moins : // 185
        regle40 () ;
      break ;
      case LEX_MOC.token_ou : // 186
        regle40 () ;
      break ;
      case LEX_MOC.token_inf : // 178
        regle41 () ;
      break ;
      case LEX_MOC.token_sup : // 180
        regle41 () ;
      break ;
      case LEX_MOC.token_infeg : // 179
        regle41 () ;
      break ;
      case LEX_MOC.token_supeg : // 181
        regle41 () ;
      break ;
      case LEX_MOC.token_eg : // 182
        regle41 () ;
      break ;
      case LEX_MOC.token_neg : // 183
        regle41 () ;
      break ;
