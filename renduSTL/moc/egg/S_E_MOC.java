...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#getType","E -> A #getType #code_gauche AFFX #verifCompatible #estAffectable #gen ;"});
}
  }
...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#auto_inh","E -> A #getType #code_gauche AFFX #verifCompatible #estAffectable #gen ;"});
}
  }
...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#estAffectable","E -> A #getType #code_gauche AFFX #verifCompatible #estAffectable #gen ;"});
}
  }
...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#code_gauche","E -> A #getType #code_gauche AFFX #verifCompatible #estAffectable #gen ;"});
}
  }
...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#gen","E -> A #getType #code_gauche AFFX #verifCompatible #estAffectable #gen ;"});
}
  }
...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#verifCompatible","E -> A #getType #code_gauche AFFX #verifCompatible #estAffectable #gen ;"});
}
  }
