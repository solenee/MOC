...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#gen","INST -> TYPE ident #tds #adresse #lire_resultat #code_gauche AFFX pv #verifCompatibilite #isReturn #gen ;"});
}
  }
...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#lire_resultat","INST -> TYPE ident #tds #adresse #lire_resultat #code_gauche AFFX pv #verifCompatibilite #isReturn #gen ;"});
}
  }
...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#adresse","INST -> TYPE ident #tds #adresse #lire_resultat #code_gauche AFFX pv #verifCompatibilite #isReturn #gen ;"});
}
  }
...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#isReturn","INST -> TYPE ident #tds #adresse #lire_resultat #code_gauche AFFX pv #verifCompatibilite #isReturn #gen ;"});
}
  }
...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#verifCompatibilite","INST -> TYPE ident #tds #adresse #lire_resultat #code_gauche AFFX pv #verifCompatibilite #isReturn #gen ;"});
}
  }
...
x_9.att_classe=this.att_classe;
x_10.att_classe=this.att_classe;
...
x_9.att_emplNull=this.att_emplNull;
x_10.att_emplNull=this.att_emplNull;
...
if (((CLASSE)loc_c).isAttribut(x_3.att_txt)!=null){
att_scanner._interrompre(IProblem.Semantic, att_scanner.getBeginLine(), IMOCMessages.id_B_233, MOCMessages.B_233,new Object[]{""+" "+x_3.att_txt+" est un attribut de la classe "});
...
this.att_stds=this.att_tds;
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#tds","INST -> TYPE ident #tds #adresse #lire_resultat #code_gauche AFFX pv #verifCompatibilite #isReturn #gen ;"});
}
  }
...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#code_gauche","INST -> TYPE ident #tds #adresse #lire_resultat #code_gauche AFFX pv #verifCompatibilite #isReturn #gen ;"});
}
  }
