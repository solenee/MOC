...
if  (att_eval)      action_verifMethodeInit_85(x_2);
  }
...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#parametres","MPARF -> ident #parametres #adresse #verifMethodeInit ;"});
}
  }
...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#adresse","MPARF -> ident #parametres #adresse #verifMethodeInit ;"});
}
  }
...
private void action_verifMethodeInit_85(T_MOC x_2) throws Exception {
try {
// locales
PARAMETRES loc_p;
INFOVAR loc_i;
...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#verifMethodeInit","MPARF -> ident #parametres #adresse #verifMethodeInit ;"});
}
  }
