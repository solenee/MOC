...
if  (att_eval)      action_gen_96(x_2, x_4);
  }
...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#parametres2","MARGS -> MARG #parametres1 MARGS1 #parametres2 #gen ;"});
}
  }
...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#parametres1","MARGS -> MARG #parametres1 MARGS1 #parametres2 #gen ;"});
}
  }
...
// instructions
this.att_code="";
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#gen","MARGS -> #parametres #gen ;"});
}
  }
...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#auto_inh","MARGS -> MARG #parametres1 MARGS1 #parametres2 #gen ;"});
}
  }
private void action_gen_96(S_MARG_MOC x_2, S_MARGS_MOC x_4) throws Exception {
try {
// locales
String loc_comment;
// instructions
loc_comment=this.att_machine.genComment("empilement des parametres");
this.att_code=loc_comment+x_4.att_code+x_2.att_code;
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#gen","MARGS -> MARG #parametres1 MARGS1 #parametres2 #gen ;"});
}
  }
...
this.att_nom="";
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#parametres","MARGS -> #parametres #gen ;"});
}
  }
