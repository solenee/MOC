...
// instructions
this.att_vide=false;
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#estVide","AFFX -> affect A #getType #estVide #gen ;"});
}
  }
...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#getType","AFFX -> affect A #getType #estVide #gen ;"});
}
  }
...
loc_leCode=this.att_machine.genWriteIndirectMem(this.att_code_gauche, loc_codedroit, glob_28_t.getTaille());
}
else {
...
}catch(RuntimeException e) {       att_scanner._interrompre(IProblem.Internal,att_scanner.getBeginLine(),ICoreMessages.id_EGG_runtime_error, CoreMessages.EGG_runtime_error,new Object[] { "MOC", "#gen","AFFX -> affect A #getType #estVide #gen ;"});
}
  }
...
if (this.att_hest_adresse){
loc_code_valeur_gauche=this.att_machine.genReadIndirectMem(this.att_htype.getTaille());
}
else {
